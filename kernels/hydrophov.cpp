...
/*
bool HydrophobicKernelV::isC1sp3(OBAtom * a)
{
    int hybr = a->GetHyb();
...
int HydrophobicKernelV::isR(OBAtom * atom)
{
    int r = 0;
...
int HydrophobicKernelV::countAl(OBAtom * atom)
{
    int r = 0;
    FOR_NBORS_OF_ATOM(nbr, atom)
    {
...
int HydrophobicKernelV::countAr(OBAtom * atom)
{
    int r = 0;
    FOR_NBORS_OF_ATOM(nbr, atom)
    {
...
int HydrophobicKernelV::aromaticHet(OBAtom *atom)
{
    int r = 0;
    FOR_NBORS_OF_ATOM(nbr, atom)
    {
...
int HydrophobicKernelV::isX(OBAtom * atom)
{
    int r = 0;
    FOR_NBORS_OF_ATOM(nbr, atom)
    {
...
int HydrophobicKernelV::get_hydrophobicity(OBAtom * a)
{
...
double HydrophobicKernelV::calculate(OBMol * mol1, OBMol * mol2, double gamma, bool norm)
{
    double w1 = 0.0;
    double w2 = 0.0;
    double  s = 0.0;
