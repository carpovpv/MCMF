...
StericKernelK::StericKernelK() : CKernel()
{
    name = "StericK";
...
double StericKernelK::steric(int atom1, int atom2)
{
    int i1, i2;
...
StericKernelK::~StericKernelK()
{
}

double StericKernelK::calculate(OBMol * mol1,bool regime,OBMol * mol2, double gamma, bool norm)
{
    double s = 0.0;
    double w2 = 0.0;
